...
## [CNN model classifying traffic signs)](./Traffic_sign_classification_using_CNN.ipynb)
(GTSRB, ~104,000 images, 43 classes) using preprocessed 32×32 pickled data from [Kaggle](https://www.kaggle.com/datasets/valentynsichkar/traffic-signs-preprocessed?select=data2.pickle)
. Includes EDA on class distribution, channel order fixes, and a 3-block Conv2D architecture with BatchNorm and dropout.
